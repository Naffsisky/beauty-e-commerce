    ...
    <ul class="minicart-product-list">
      <li>
        <a href="single-product.html" class="image"
          ><img src="assets/img/product/SABUNW2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          ...
          <span class="quantity-price"
            >1 x <span class="amount">IDR100.000</span></span
          >
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="assets/img/product/SW2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >SERUM</a
          >
          <span class="quantity-price"
            >1 x <span class="amount">IDR135.000</span></span
          >
          <a href="#" class="remove">×</a>
        </div>
      </li>
      <li>
        <a href="single-product.html" class="image"
          ><img src="assets/img/product/SB2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >SCRUB</a
          >
          <span class="quantity-price"
            >1 x <span class="amount">IDR130.000</span></span
          >
          <a href="#" class="remove">×</a>
        </div>
      </li>
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
  <div class="inner">
    ...
    <ul class="minicart-product-list">
      <li>
        <a href="single-product.html" class="image"
          ><img src="assets/img/product/BL2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >Body LOTION</a
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="assets/img/product/MSS2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >MOIZTURIZER</a
          >
          <span class="quantity-price"
            >1 x <span class="amount">IDR150.000</span></span
          >
          <a href="#" class="remove">×</a>
        </div>
      </li>
      <li>
        <a href="single-product.html" class="image"
          ><img src="assets/img/product/HB2.png" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >NIVEA</a
          >
          <span class="quantity-price"
            >1 x <span class="amount">IDR45.000</span></span
          >
          <a href="#" class="remove">×</a>
        </div>
      </li>
    ...
    <div class="sub-total d-flex flex-wrap justify-content-between">
      ...
      <span class="amount">IDR295.000</span>
    </div>
    <a
      href="cart.html"
    ...
    <a
      ...
      >checkout</a
    >
    <p class="minicart-message">Free Shipping on All Orders Over IDR1000.000</p>
  </div>
</div>
<!-- OffCanvas Cart End -->
            ...
            >
              ...
              <li>
                <a
                  ...
                  aria-haspopup="true"
                  aria-expanded="false"
                  >IDR <i class="ion ion-ios-arrow-down"></i>
                </a>
                <ul
                  class="topnav-submenu dropdown-menu"
                  aria-labelledby="dropdown2"
                >
                  <li class="active"><a href="#">IDR</a></li>
                  <li><a href="#">Rp</a></li>
                </ul>
              </li>
              <li class="english">
        ...
        <div class="col-lg-3 col-sm-6 py-3">
          <div class="d-flex static-media2 flex-column flex-sm-row">
            ...
            <div class="media-body">
              ...
              <p class="text">On all orders over IDR75.000</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 py-3">
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/TN2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          >
                            <span class="product-price">IDR110.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SABUNW2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SW2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/MSS2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SC2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SC2.2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          <div
                            class="d-flex align-items-center justify-content-between"
                          >
                            <span class="product-price">IDR50.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#add-to-cart"
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/MSS2.2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          <div
                            class="d-flex align-items-center justify-content-between"
                          >
                            <span class="product-price">IDR40.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#add-to-cart"
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/PL2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          <div
                            class="d-flex align-items-center justify-content-between"
                          >
                            <span class="product-price">IDR130.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#add-to-cart"
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/FC2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SW2.2.png"
                            alt="thumbnail"
                          />
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/BL2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SABUN2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          <div
                            class="d-flex align-items-center justify-content-between"
                          >
                            <span class="product-price">IDR60.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#add-to-cart"
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SB2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/HB2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          <div
                            class="d-flex align-items-center justify-content-between"
                          >
                            <span class="product-price">IDR45.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#add-to-cart"
                    ...
                    <div class="media flex-column">
                      <div class="product-thumbnail position-relative">
                        ...
                        <a href="single-product.html">
                          <img
                            class="first-img"
                            src="assets/img/product/SBB2.png"
                            alt="thumbnail"
                          />
                        </a>
                        <!-- product links -->
                      ...
                      <div class="media-body">
                        <div class="product-desc">
                          ...
                          <div
                            class="d-flex align-items-center justify-content-between"
                          >
                            <span class="product-price">IDR80.000</span>
                            <button
                              class="pro-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#add-to-cart"
          ...
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/UPN.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/DIOR.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/SCARLETT.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/CHANEL.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/INNISFREE.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/IVE.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
          <div class="slider-item">
            <div class="single-brand">
              <a
                ...
                class="brand-thumb"
              >
                <img src="assets/img/brand/BP.png" alt="brand-thumb-nail" />
              </a>
            </div>
          </div>
          <!-- slider-item end -->
            ...
            <div class="modal-product-info">
              ...
              <div class="product-body">
                <span class="product-price text-center">
                  <span class="new-price">IDR29.00</span>
                </span>
                <p>
