...
if ($sort === 'terbaru') {
    ...
    $aduan = query("SELECT * FROM aduan ORDER BY id ASC");
    $sortText = 'Sort by oldest';
} 
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Beautyku | Aduan Pembeli</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Aduan Pembeli</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="../../">Home</a></li>
                  <li class="breadcrumb-item active">Aduan Pembeli</li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="container-fluid">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="?sort=terbaru" data-sort="terbaru">Newest</a>
                    <a class="dropdown-item" href="?sort=terlama" data-sort="terlama">Oldest</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="../report/">Default</a>
                  </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <!-- Foto produk -->
                        <img src="../katalog/img/bodycare/a.jpg" alt="Foto Produk" class="product-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Informasi pembeli, nama produk, dan pesan -->
