                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">Elon Musk</td>
                      <td class="text-center">27-7-2077</td>
                      <td class="text-center"><span class="tag tag-success">Done</span></td>
                      <td class="text-center">MS Glow for Man - Body lotion</td>
                      <td class="text-center">Bodycare</td>
                      <td class="text-center">2</td>
                      <td class="text-center text-success">Rp150.000</td>
                    </tr>
                  </tbody>
                </table>
              </div>
