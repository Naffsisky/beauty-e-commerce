...
$produk = query("SELECT * FROM produk WHERE kategori = 'makeup'");
...
if(isset($_POST["cari"])){
  $produk = cari_makeup($_POST["keyword"]);
}
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Katalog Makeup</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
        ...
        <div class="container" id="content">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="../makeup/">Default</a>
            </div>
          </div>
